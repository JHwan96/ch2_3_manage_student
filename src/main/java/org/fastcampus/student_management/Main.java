...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        CourseInfoDto courseInfoDto = new CourseInfoDto("바이올린", 1000, "MONDAY", "홍길동", 1717290000L);
        CourseInfoDto courseInfoDto1 = new CourseInfoDto("첼로", 1200, "MONDAY", "존도", 1717290000L);
